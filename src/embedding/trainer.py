...
class TrainingConfig:
    ...
    model_path: str = field(default_factory=lambda: os.environ.get('QWEN_MODEL_0_6B', 'qwen3_embedding_0.6B'))
    max_length: int = 512
    ...
    output_dir: str = field(default_factory=lambda: os.path.join(os.environ.get('EMBEDDING_DIR', 'embedding'), 'outputs'))
    checkpoint_dir: str = field(default_factory=lambda: os.path.join(os.environ.get('EMBEDDING_DIR', 'embedding'), 'checkpoints'))
    result_dir: str = field(default_factory=lambda: os.environ.get('RESULT_DIR', 'result'))
