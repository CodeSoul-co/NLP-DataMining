...
def load_doc_embeddings(
    ...
    # Support multiple embedding file naming conventions and directory structures
    emb_candidates = [
        os.path.join(embedding_dir, f"{dataset}_{mode}_embeddings.npy"),
        os.path.join(embedding_dir, "embeddings.npy"),
        # Also check mode subdirectory (e.g., embeddings/zero_shot/edu_data_zero_shot_embeddings.npy)
        os.path.join(embedding_dir, mode, f"{dataset}_{mode}_embeddings.npy"),
        os.path.join(embedding_dir, mode, "embeddings.npy"),
    ]
    ...
    label_candidates = [
        os.path.join(embedding_dir, f"{dataset}_{mode}_labels.npy"),
        os.path.join(embedding_dir, "labels.npy"),
        # Also check mode subdirectory
        os.path.join(embedding_dir, mode, f"{dataset}_{mode}_labels.npy"),
        os.path.join(embedding_dir, mode, "labels.npy"),
    ]
