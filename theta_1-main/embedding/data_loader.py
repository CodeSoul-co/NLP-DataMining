...
class DatasetLoader:
    ...
    Datasets:
        ...
        - edu_data: Chinese education data (unlabeled)
    """
    ...
    def __init__(self, base_path: str = None, dev_mode: bool = False):
        """
        Initialize data loader.
        
        Args:
            base_path: Root directory of the project (default: from env or /root/autodl-tmp)
            dev_mode: If True, print debug information
        """
        if base_path is None:
            base_path = os.environ.get('ETM_BASE_DIR', '/root/autodl-tmp')
