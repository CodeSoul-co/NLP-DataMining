...
class TextQAAgent:
    ...
    def __init__(self, base_dir: str = "/root/autodl-tmp", llm_config: Optional[Dict] = None):
        ...
        # Integrate result interpreter agent
        self.result_interpreter = ResultInterpreterAgent(base_dir, llm_config)
    ...
    def process_with_history(
        ...
        """
        Q&A processing with multi-turn conversation support
        ...
        Returns:
            Dictionary containing answer and session ID
        """
        # Use ResultInterpreterAgent for processing
        return self.result_interpreter.answer_question(job_id, question, session_id)
    
    def interpret_metrics(self, job_id: str, language: str = "zh") -> Dict[str, Any]:
        """
        ...
        Returns:
            Dictionary containing metric interpretations
        """
        return self.result_interpreter.interpret_metrics(job_id, language)
    
    def interpret_topics(self, job_id: str, language: str = "zh") -> Dict[str, Any]:
        """
        Interpret topic content
        ...
        """
        return self.result_interpreter.interpret_topics(job_id, language)
    
    def generate_summary(self, job_id: str, language: str = "zh") -> Dict[str, Any]:
        """
        ...
        """
        return self.result_interpreter.generate_summary(job_id, language)
    
    def clear_history(self, session_id: str) -> None:
        """Clear conversation history for specified session"""
        if session_id in self.conversation_history:
            del self.conversation_history[session_id]
        if session_id in self.result_interpreter.conversation_history:
            del self.result_interpreter.conversation_history[session_id]
