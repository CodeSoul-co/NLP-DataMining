"""
Topic Models Module - Topic models module

Supports multiple topic models:
- ETM: Embedded Topic Model (uses Qwen embedding)
- CTM: Contextualized Topic Model (contextualized topic model)
- LDA: Latent Dirichlet Allocation (classic LDA)
- DTM: Dynamic Topic Model (dynamic topic model, reserved)

All models implement a unified interface for easy comparative experiments.
"""
