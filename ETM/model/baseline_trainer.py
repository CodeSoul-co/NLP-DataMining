...
class BaselineTrainer:
    ...
    def prepare_data(
        ...
        sbert_model: str = '/root/autodl-tmp/ETM/model/sbert/sentence-transformers/all-MiniLM-L6-v2'
    ):
        """
        Prepare data
...
def main():
    ...
    parser.add_argument('--sbert_model', type=str, default='/root/autodl-tmp/ETM/model/sbert/sentence-transformers/all-MiniLM-L6-v2', help='SBERT model name')
